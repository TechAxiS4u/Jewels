...
<body onload="window.print();"><!--  -->
	...
	$CI =& get_instance();
  	...
  	$q3=$this->db->query("SELECT b.coupon_id,b.coupon_amt, b.created_by,b.created_by_address, b.customer_previous_due,b.customer_total_due,b.store_id,a.customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,a.delete_bit,b.invoice_terms,
                           ...
                           b.payment_status,b.warehouse_id,c.warehouse_name,c.mobile,c.email,c.warehouse_address

                           FROM db_customers a,
                           db_sales b, db_warehouse c
                           WHERE 
    ...
    $res3=$q3->row();
    $warehouse_address=$res3->warehouse_address;
    $warehouse_email=$res3->email;
    $warehouse_phone=$res3->mobile;
    ...
    $created_by_address=$res3->created_by_address;
		...
		<tr>
			<td align="center">
               ...
               <!--  	<?php echo (!empty(trim($company_address))) ? $this->lang->line('company_address')."".$company_address."<br>" : '';?> 
		            <?= $company_city; ?> -->
		            <!-- <?= print $created_by_address ?> -->
		            
		           <?php echo (!empty(trim($warehouse_address))) ? $this->lang->line('company_address')."".$warehouse_address."<br>" : '';?> 
		            ...
		            <?php echo (!empty(trim($warehouse_phone))) ? "Phone: ".$warehouse_phone : '';?>
		            <br>
		            <?php 
					...
					<tr>
						...
						?>
							<div style="display:inline-block;vertical-align:middle;line-height:16px !important;">
								<img src="<?= base_url('uploads/company/Tech_Axis_QR.png');?>" width="50%" height="auto">
								<?php
