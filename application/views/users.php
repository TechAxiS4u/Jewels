                           ...
                           <div class="box-body">
                            <div class="row">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                 <label for="last_name" class="col-sm-4 control-label">Address<label class="text-danger">*</label></label>
                                 <div class="col-sm-8">
                                    <textarea type="text" class="form-control input-sm "  id="user_address" name="user_address" autocomplete='off' placeholder=""><?= $user_address; ?></textarea>
                                    <span id="user_address_msg" style="display:none" class="text-danger"></span>
                                 </div>
                              </div>
