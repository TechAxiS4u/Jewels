                              ...
                              <div class="col-xs-12 ">
                                 <div class="col-sm-12">
                                       ...
                                       <!-- /.box-header -->
                                        ...
                                        <th rowspan='2' style="width:10%"><?= $this->lang->line('total_amount'); ?></th>
                              ...
                              <div class="col-md-6">
                                <div class="row">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="" class="col-sm-4 control-label"><?= $this->lang->line('total_amount'); ?></label>    
                                          <div class="col-sm-4">
                                             <label class="control-label total_amount text-success" style="font-size: 15pt;">0</label>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
           ...
           for(i=1;i<=rowcount;i++){
             if(document.getElementById("td_data_"+i+"_1")){
               ...
               if($("#td_data_"+i+"_1").val()!=null && $("#td_data_"+i+"_1").val()!=''){ 
                    ...
                    total_amount +=parseFloat($("#td_data_"+i+"_4").val());
                }
