        ...
        <div class="col-xs-12 table-responsive">
          <table class="table  records_table table-bordered">
            ...
            <tbody>
              ...
              $q2=$this->db->query("SELECT c.item_name,c.sales_price, a.transfer_qty
                                  FROM 
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td>".($res2->sales_price)*(format_qty($res2->transfer_qty))."</td>";
                  echo "</tr>";  
                  $tot_qty +=$res2->transfer_qty;
                  $tot_amount += ($res2->sales_price)*(format_qty($res2->transfer_qty));
              }
              ?>
            ...
            <tfoot class="text-right text-bold bg-gray">
              <tr>
                ...
                <td class="text-left"><?=$tot_amount;?></td>
              </tr>
            </tfoot>
          </table>
        </div>
