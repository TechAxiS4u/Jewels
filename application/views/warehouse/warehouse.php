      ...
      <div class="wrapper">
         ...
         <?php
            if(!isset($warehouse_name)){
              $warehouse_name=$mobile=$warehouse_address=$email=$q_id='';
              $disabled='';
            }else{
                     ...
                     <div class="box box-primary ">
                        ...
                        <form class="form-horizontal" id="warehouse-form" onkeypress="return event.keyCode != 13;">
                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                                 <label for="warehouse_address" class="col-sm-2 control-label">Address<label class="text-danger">*</label></label>
                                 <div class="col-sm-4">
                                    <textarea class="form-control input-sm" id="warehouse_address" name="warehouse_address" placeholder=""><?php print $warehouse_address; ?></textarea>
                                    <span id="warehouse_address_msg" style="display:none" class="text-danger"></span>
                                 </div>
                              </div>
