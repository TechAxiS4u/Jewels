...
class Warehouse_model extends CI_Model {
	...
	public function verify_and_save($data){
		...
		$query1="insert into db_warehouse(store_id,warehouse_type,warehouse_name,mobile,warehouse_address,email,status,created_date) 
			values($store_id,'Custom','$warehouse_name','$mobile','$warehouse_address','$email',1,'$CUR_DATE')";
	...
	public function verify_and_update($data){
		...
		$query1="UPDATE db_warehouse SET warehouse_name='$warehouse_name', mobile='$mobile',warehouse_address='$warehouse_address', email='$email' where id=$q_id and store_id=$store_id";
	...
	public function get_details($id){
		...
		if($query->num_rows()==0){
			...
			$data['warehouse_address']=$query->warehouse_address;
