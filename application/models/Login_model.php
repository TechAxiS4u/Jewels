...
$this->db->select("a.email,a.store_id,a.id,a.username,a.role_id,b.role_name,a.status,a.last_name,a.user_address,a.default_warehouse_id");
		...
		if($query->num_rows()==1){
			...
			$logdata = array(
							...
							'user_address'  => $query->row()->user_address,
				        	 'inv_userid'  => $query->row()->id,
				        	 'inv_default_warehouse_id'  => $query->row()->default_warehouse_id,
				        	 'logged_in' => TRUE,
