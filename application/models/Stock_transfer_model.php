		...
		?>
            <tr id="row_<?=$rowcount;?>" data-row='<?=$rowcount;?>'>
               ...
               <td id="td_<?=$rowcount;?>_4">
                  <!-- item name  -->
                  <input type="text" style="font-weight: bold;" id="td_data_<?=$rowcount;?>_4" class="form-control no-padding" value='<?=$item_sales_price * format_qty($item_stock_qty);?>' readonly >
               </td>
