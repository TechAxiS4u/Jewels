...
class MyPDF extends TCPDF {
    ...
    public function _get_company_details()
    {
        ...
        $store = $this->store;
        $sales = $this->sales;
        $usercreatedaddr = $sales->created_by_address;
        
        $txt='';
        $txt .= '<span style="font-size:16px;font-weight:500">'.$store->store_name.'</span>';
        $txt .= '<br><span style="font-size:12px;">'.$usercreatedaddr.'</span>';
    ...
    public function _get_qr()
    {
        ...
        $image_file= 'uploads/company/Tech_Axis_QR.png';
        $x = ($this->_rtl) ? 203 : 174;// for RTL 203
        $this->Image($image_file, $x, $y = '', 30, '', '', '', 'T', false, 300, '', false, false, $border =0, false, false, false);
        return $this;
