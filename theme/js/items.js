...
function updateItemName() {
    ...
    var itemCustomBarcodeField = document.getElementById('custom_barcode');

    itemNameField.value = itemCodeField.value;
    itemCustomBarcodeField.value = itemCodeField.value;
}
