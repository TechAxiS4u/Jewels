...
$("#save,#update").on("click",function(){
      ...
      if (email!='' && !validateEmail(email)) {
        ...
        //if(confirm("Are you sure ?")){
         ...
         $.post(base_url+"warehouse/save_or_update",{command:this_id,q_id:q_id,warehouse_name:warehouse_name,email:email,mobile:mobile,warehouse_address:warehouse_address,store_id:$("#store_id").val()},function(result){
			   result=result;
            if(result=="success"){
