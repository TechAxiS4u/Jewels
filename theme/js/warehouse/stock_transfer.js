...
function increment_qty(rowcount){
  ...
  var item_total_value=$("#td_data_"+rowcount+"_4").val();
  var item_value=item_total_value/item_qty;
  ...
  if(parseFloat(item_qty)<parseFloat(available_qty)){
    ...
    item_total_value = item_value*item_qty;
    $("#td_data_"+rowcount+"_3").val(format_qty(item_qty));
    $("#td_data_"+rowcount+"_4").val(item_total_value);
  }
  calculate_quantity();
}
//DECREMENT ITEM
function decrement_qty(rowcount){
  ...
  if(item_qty<=1){
    ...
    $("#td_data_"+rowcount+"_4").val(item_value);
    return;
  }
  item_qty = format_qty(item_qty)-1;
  item_total_value = item_value*item_qty;
